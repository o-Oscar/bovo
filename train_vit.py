...
def valid(args, model, writer, test_loader, global_step):
    ...
    writer["test/loss"] = eval_losses.avg
...
# python vit_train.py --name vit0 --train_batch_size 32 --eval_batch_size 32 --eval_every 64 --gradient_accumulation_steps 1 --learning_rate 1e-2 --img_size 300 --wandb
